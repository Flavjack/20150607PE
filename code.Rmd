...
(ref:gerplot) . Response of *Jatropha curcas* seeds after different imbition time. (A) pH and Electrical Conductivity (EC). (B) Seed Moisture (SMT) and Seed Water Content (SWC). Means are represent with (±SE) of four replicates.
...
swr <- ggdraw(xlim = c(0, 0.55), ylim = c(0, 1))+
          draw_plot(ce_plot,  width = 0.5, height = 0.25, x = 0.0, y = 0.75) +
          draw_plot(pH_plot,  width = 0.5, height = 0.25, x = 0.0, y = 0.50) +
          draw_plot(smt_plot, width = 0.5, height = 0.25, x = 0.0, y = 0.25) +
          draw_plot(swc_plot, width = 0.5, height = 0.25, x = 0.0, y = 0.0) +
          draw_plot_label(
            label = c("A", "B", "C", "D"), 
            x = c(0.5, 0.5, 0.5, 0.5), 
            y = c(0.2, 0.45, 0.7, 0.90))
