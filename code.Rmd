...
```{r swr, fig.cap= "Response of *Jatropha curcas* seeds after different imbition time. (A) Electrical conductivity; (B) pH; (C) Seed moisture and  (D) Seed water content. The letter represent the mean difference with Student-Newman-Keuls test (p ≤ 0.05). Means are represent with (±SE). n = 4."}
...
```{r grm, fig.cap='(A) Germination (%); (B) Mean germination time (days); (C) Germination synchrony and (D) Germination uncertany (bits) in *Jatropha curcas* seeds after different imbition times. The letter represent the mean difference with Student-Newman-Keuls test (p ≤ 0.05). Means are represent with (±SE). n = 4.'}
...
ppi <- 300
png("img/fig_04.png", width=8*ppi, height=8*ppi, res=ppi)
